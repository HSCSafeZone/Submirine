...
public class SafeZoneServer extends JFrame {
    ...
    class Client extends Thread {
        ...
        private void broadcastChatMessage(String chat) {
            String chatMessage = chat.substring(5); // "CHAT:" 다음 부분만 추출
            String formattedMessage = player.getName() + ": " + chatMessage;
            for (Client client: clients) {
                client.sendMessage("CHAT:" + formattedMessage);
            }
        }
